                ...
                <div class="col-xl-5 col-lg-12 col-md-12 e-d-info-notices">
                    <div class="row">
                        ...
                        @if (in_array('notice_period_duration', $activeWidgets))
                            @if(collect($noticePeriod)->isNotEmpty())
                                @include('dashboard.employee.ajax.notice-period')
                            @endif
                        @endif
                        @if (in_array('probation_date', $activeWidgets))
                            @if(collect($probation)->isNotEmpty())
                                @include('dashboard.employee.ajax.probation')
                            @endif
                        @endif
                        @if (in_array('internship_date', $activeWidgets))
                            @if(collect($internship)->isNotEmpty())
                                @include('dashboard.employee.ajax.internship')
                            @endif
                        @endif
                        @if (in_array('contract_date', $activeWidgets))
                            @if(collect($contract)->isNotEmpty())
                                @include('dashboard.employee.ajax.contract')
                            @endif
                        @endif
