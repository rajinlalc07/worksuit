...
class NewTicketReply extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return parent::build()
            ...
            ->line(__('email.ticketReply.text') . $this->ticket->ticket_number)
    ...
    public function toSlack($notifiable)
    {
        ...
        return $message->content('This is a redirected notification. Add slack username for *' . $notifiable->name . '*');
    }
