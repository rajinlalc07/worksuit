...
class IncomeVsExpenseReportController extends AccountBaseController
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Reply::dataOnly(['status' => 'success', 'html' => $html, 'title' => $this->pageTitle, 'totalEarning' => currency_format($this->chartData['totalEarning']), 'totalExpense' => currency_format($this->chartData['totalExpense'])]);
        }
